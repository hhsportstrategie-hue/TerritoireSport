...
- Tokens club/contact/partner (DB parcours) : pour le wizard parcours utilisateur
...
# ════════════════════════════════════════════════════════════════
# Helpers mot de passe / tokens préfixés
# ════════════════════════════════════════════════════════════════


def hash_password(password: str) -> str:
    """Hash d'un mot de passe (SHA-256 + sel fixe). Pour session club (démo)."""
    salt = "territoire-sport-club-2026"
...
def generate_token(prefix: str = "TKN") -> str:
    """Génère un token préfixé (ex: CLUB_abc123, CONTACT_xyz789, PARTNER_xxx)."""
